      ...
      >
        <motion.div variants={item1} className="left__analytics">
          <div className="left__text">
            <h1>Okay, let's see our school courses</h1>
            <p>
              Our school provides different types of courses , trainings and workshops that helps students improve their technical skills so that they can be prepared for the professional world and be one of the leaders in the future ! 
